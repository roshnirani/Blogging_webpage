...
const Home = () => {
  const blogs = [
    ...
    },
    {
      ...
      description: "How to style React apps quickly with Tailwind...",
      image: "https://miro.medium.com/v2/resize:fit:1400/1*__f27S-qQF2CAASt5bOwqg.png",
    },
    {
      title: "JavaScript ES6 Features",
      description: "Learn the latest ES6+ features like arrow functions, template literals, and destructuring.",
    ...
    },
    {
      ...
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRyj9xFRvYqlIYFiC3TpLxDTs36q10TJCyQzQ&s",
    },
    {
      title: "Mastering CSS: Styling the Web",
      description: " Learn how to enhance layouts, apply animations, and create responsive designs",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRba558gMt525yOmdRRZzXF6b9r4RlL0r_Sug&s",
    },
    {
      title: "PHP for Web Development",
      description: " Learn how PHP powers dynamic websites and server-side scripting",
      image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSCB2Yimv6QMAzjR2kYvqQITCcsfca3Mp8AjQ&s",
    },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-6 text-white">Welcome to My Blog</h1>
